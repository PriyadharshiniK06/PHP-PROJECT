       ...
       <span class="navbar-toggler-icon"></span>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <ul class="dropdown-menu" >
                                <li><a class="dropdown-item" href="pricing-plan.php" style="padding-left:35px;padding-right:35px;color:red">Pricing Plan</a></li>
    ...
    <div class="container-fluid">
        <div class="row ">
            <div class="col-lg-6 mt-4 col-12 col-sm-6 mb-4">
                ...
                <h1 style="color:blueviolet;font-size:30px">Request A Free Quote!!</h1>
                ...
                <div class="d-flex flex-column flex-md-row ">
                       ...
                       <div class="d-flex flex-column ms-4">
                           <h2 style="color:green;font-size:25px">Call for any query!</h2> 
                           <h4>+91 9503820394</h4>
                        </div>
                </div>
              </div>
