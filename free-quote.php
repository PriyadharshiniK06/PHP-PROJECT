       ...
       <span class="navbar-toggler-icon"></span>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <ul class="dropdown-menu" >
                                ...
                                <li><a class="dropdown-item" href="free-quote.php" style="padding-left:40px;padding-right:40px;color:red">Free Quote</a></li>
            ...
            <div class="col-lg-6 mt-4 col-12 col-sm-6 mb-4">
                ...
                <div class="d-flex flex-column flex-md-row ">
                       ...
                       <div class="d-flex flex-column ms-4">
                           <h2 style="color:aqua;font-size:20px">Call for any query!</h2> 
                           <h4>+91 9503820394</h4>
                        </div>
                </div>
              </div>
